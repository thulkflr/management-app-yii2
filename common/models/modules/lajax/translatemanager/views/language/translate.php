...
$this->title = Yii::t('app', 'Default Translation For {language_id}', ['language_id' => $language_id]);
        ...
        <div class="col-md-12">
            <div class="main-card mb-3 card">
                <div class="card-header">
                    ...
                    <?= $this->title ?>
                    <?= $this->render('@backend/views/common/tableHeadSearch.php', ['model' => $searchModel, 'uri' => Url::to(['translate','language_id'=>$language_id])]) ?>
                ...
                <div class="card-body">
                    <div id="filters" class="row"
                        ...
                        <div class="col-md-12">
                            <?= $this->render('_search_translation', ['model' => $searchModel, 'searchEmptyCommand' => $searchEmptyCommand, 'searchNonEmptyCommand' => $searchNonEmptyCommand,'language_id'=>$language_id]) ?>
                        </div>
                    </div>
        ...
        'columns' => [
            ...
            [
                ...
                'content' => function ($data, $key, $index, $column) {
                    // return Html::button(Yii::t('app', 'Save'), ['type' => 'button', 'data-id' => $data->id, 'class' => 'btn btn-lg btn-success margin-right-15']) .
                    //        Html::tag('a', Html::encode(Yii::t('app', 'Update Source')), ['class'=>'btn btn-lg btn-primary btn-translation-modal', 'data-id' => $data->id]);'class' => 'btn btn-table btn-default',
                    return Html::button('<i class="fa fa-save"></i> ' .Yii::t('app', 'Save'), ['type' => 'button', 'data-id' => $data->id, 'class' => 'btn btn-lg btn-default margin-right-15  save-translate-'.$index]);
                },
            ],
        ],
