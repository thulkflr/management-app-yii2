...
$this->title = Yii::t('app', 'Admin Translations : List of languages');
                    ...
                    'columns' => [
                        ...
                        [
                            ...
                            'content' => function ($model) {
                                return '<div class="progress-bar-animated-alt progress"><div class="progress-bar bg-success" role="progressbar" aria-valuenow="'.$model->getDefaultBackendTranslationtSatistic($model->lang->code).'" aria-valuemin="0" aria-valuemax="100" style="width: '.$model->getDefaultBackendTranslationtSatistic($model->lang->code).'%;">' . $model->getDefaultBackendTranslationtSatistic($model->lang->code) . '%</div></div>';
                            },
                        ],
                        [
                            ...
                            'value' => function ($model) {
                                return AdminThemeHelper::getTableActions([
                                    Html::a('<i class="dropdown-icon lnr-spell-check"></i> ' . Yii::t('app', 'Edit Translation'), Url::to(['language/translate-backend', 'language_id' => $model->lang->code]), ['class' => 'dropdown-item']),
                                ]);
                            },
                            'format' => 'raw',
                            'options' => [
