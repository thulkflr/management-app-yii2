...
use yii\helpers\Url;
use common\models\ThirdPartySetting;
use common\models\AdvLocation;
...
<div class="col-md-12">
    <div class="card-hover-shadow-1x mb-3">
        ...
        <div class="row mt-3">
            ...
            <div class="col-md-6">
                <?= $form->field($model, 'code')->textInput(['placeholder' => Yii::t('app', 'Type To Search ...')]); ?>
            </div>
