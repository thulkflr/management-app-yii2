...
$this->title = Yii::t('app', 'Default Translations : List of languages');
                        ...
                        [
                            ...
                            'value' => function ($model) {
                                return AdminThemeHelper::getTableActions([
                                    Html::a('<i class="dropdown-icon lnr-spell-check"></i> ' . Yii::t('app', 'Edit Translation'), Url::to(['language/translate', 'language_id' => $model->lang->code]), ['class' => 'dropdown-item']),
                                ]);
                            },
                            'format' => 'raw',
                            'options' => [
