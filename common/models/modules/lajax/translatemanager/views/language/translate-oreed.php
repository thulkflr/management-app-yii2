...
$this->title = Yii::t('app', 'Oreed Translation For {language_id}', ['language_id' => $language_id]);
$this->params['breadcrumbs'][] = ['label' => Yii::t('app', 'Organizations Setup'), 'url' => ['/site/menu-page','type'=>'organizations_setup']];
$this->params['breadcrumbs'][] = ['label' => Yii::t('app', 'Languages'), 'url' => ['list-oreed']];
        ...
        <div class="col-md-12">
            <div class="main-card mb-3 card">
                <div class="card-header">
                    ...
                    <?= $this->title ?>
                    <?= $this->render('@backend/views/common/tableHeadSearch.php', ['model' => $searchModel, 'uri' => Url::to(['translate-oreed','language_id'=>$language_id])]) ?>
                ...
                <div class="card-body">
                    <div id="filters" class="row"
                        ...
                        <div class="col-md-12">
                            <?= $this->render('_search_oreed_translation', ['model' => $searchModel, 'searchEmptyCommand' => $searchEmptyCommand, 'searchNonEmptyCommand' => $searchNonEmptyCommand,'language_id'=>$language_id]) ?>
                        </div>
                    </div>
